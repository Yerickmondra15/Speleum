...
export const MOVEMENT_STEP_INTERVAL_MS = 80;
export const ATTACK_COOLDOWN = 950;
export const PARRY_WINDOW_MS = 850;
export const PARRY_COOLDOWN_MS = 4800;
export const STUN_DURATION_MS = 1800;
...
export const characterOptions: CharacterOption[] = [
  {
    ...
    status: "available",
    moveRange: getCreatureGameplayModifiers("cave-axolotl").moveRangeTiles * TILE_SIZE,
    moveCooldownMultiplier: getCreatureGameplayModifiers("cave-axolotl").moveCooldownMultiplier,
    moveSignalMultiplier: getCreatureGameplayModifiers("cave-axolotl").noiseMultiplier,
  ...
  },
  {
    ...
    status: "available",
    moveRange: getCreatureGameplayModifiers("cave-crab").moveRangeTiles * TILE_SIZE,
    moveCooldownMultiplier: getCreatureGameplayModifiers("cave-crab").moveCooldownMultiplier,
    moveSignalMultiplier: getCreatureGameplayModifiers("cave-crab").noiseMultiplier,
  ...
  },
  {
    ...
    status: "available",
    moveRange: getCreatureGameplayModifiers("blind-fish").moveRangeTiles * TILE_SIZE,
    moveCooldownMultiplier: getCreatureGameplayModifiers("blind-fish").moveCooldownMultiplier,
    moveSignalMultiplier: getCreatureGameplayModifiers("blind-fish").noiseMultiplier,
  ...
  },
  {
    ...
    status: "available",
    moveRange: getCreatureGameplayModifiers("cave-shrimp").moveRangeTiles * TILE_SIZE,
    moveCooldownMultiplier: getCreatureGameplayModifiers("cave-shrimp").moveCooldownMultiplier,
    moveSignalMultiplier: getCreatureGameplayModifiers("cave-shrimp").noiseMultiplier,
  ...
  },
  {
    ...
    status: "available",
    moveRange: getCreatureGameplayModifiers("cave-spider").moveRangeTiles * TILE_SIZE,
    moveCooldownMultiplier: getCreatureGameplayModifiers("cave-spider").moveCooldownMultiplier,
    moveSignalMultiplier: getCreatureGameplayModifiers("cave-spider").noiseMultiplier,
