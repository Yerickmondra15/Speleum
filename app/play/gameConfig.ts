...
export const DARKNESS_SANITY_DRAIN = 0.55;
export const MOVING_SANITY_RECOVERY = 1.25;
export const IDLE_SANITY_DRAIN = 1.4;
export const SAFE_ZONE_SANITY_RECOVERY = 1.75;
export const CHASE_SANITY_DRAIN = 0.9;
export const SANITY_IDLE_GRACE_MS = 4 * 60 * 1000;
export const THREAT_WARNING_MS = 3 * 60 * 1000;
export const THREAT_HUNT_MS = 4 * 60 * 1000;
export const THREAT_DEATH_MS = 5 * 60 * 1000;
export const SANITY_DAMAGE_THRESHOLD = 12;
export const SANITY_DAMAGE_PER_TICK = 4;
