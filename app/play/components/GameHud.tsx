...
export function GameHud({
  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute left-4 top-[15.8rem] z-[70] hidden w-[19rem] rounded-[1.25rem] border border-white/10 bg-black/45 p-4 backdrop-blur-md sm:block">
